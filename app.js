document.getElementById("act").style.display = "none"; //ocultar nboton actualizar
var myArrayArtculo = [];
objart={ //se define objeto articulo
    cod:null,
    nom:null,
    und:null,
    cantexist:null,
...
var posAct;
comprobarLocalStorage(); //verificar su hay item en la memoria local
function guardar(){
